...
-- I modidied original script adding #session table 
-- script runs 3-10 seconds
...
---	@output_column_list VARCHAR(8000) = '[dd%][session_id][sql_text][sql_command][login_name][wait_info][tasks][tran_log%][cpu%][temp%][block%][reads%][writes%][context%][physical%][query_plan][locks][%]',
	@output_column_list VARCHAR(8000) = '[session_id][status][sql_text][sql_command][wait_info][tasks][cpu%][reads%][writes%][block%][blocked_session_count][context%][locks][login_name][host_name]',--[tran_log%][cpu%][block%][reads%][writes%][context%][physical%][query_plan][locks][%]',
	...
	@sort_order VARCHAR(500) = '[cpu] DESC', --'[start_time] ASC',
